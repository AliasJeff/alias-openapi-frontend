        ...
        <div hidden={loading}>
          ...
          >
            <Descriptions column={1}>
              <Descriptions.Item labelStyle={{fontSize: 17}} contentStyle={{fontSize: 17}}
                                 label="订单号">{orderData?.orderSn}</Descriptions.Item>
              <Descriptions.Item labelStyle={{fontSize: 17}} contentStyle={{fontSize: 17}}
                                 label="交易凭证号">{payInfo?.tradeNo}</Descriptions.Item>
              <Descriptions.Item labelStyle={{fontSize: 17}} contentStyle={{fontSize: 17}}
                                 label="付款时间">{transformTimestamp(payInfo?.gmtPayment)}</Descriptions.Item>
              <Descriptions.Item labelStyle={{fontSize: 17}} contentStyle={{fontSize: 17}}
                                 label="付款金额">{payInfo?.totalAmount}</Descriptions.Item>
              <Descriptions.Item labelStyle={{fontSize: 17}} contentStyle={{fontSize: 17}}
                                 label="支付宝id">{payInfo?.buyerId}</Descriptions.Item>
            </Descriptions>
          </Result>
        </div>
      </ProCard>
