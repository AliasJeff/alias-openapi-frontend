...
/** getInvokeCount GET /api/userInterfaceInfo/getInvokeCount */
export async function getInvokeCountUsingGET(options?: { [key: string]: any }) {
  return request<API.BaseResponseint>('/api/userInterfaceInfo/getInvokeCount', {
    method: 'GET',
    ...(options || {}),
  });
}

/** getStars GET /api/userInterfaceInfo/getStars */
export async function getStarsUsingGET(options?: { [key: string]: any }) {
  return request<API.BaseResponseint>('/api/userInterfaceInfo/getStars', {
    method: 'GET',
    ...(options || {}),
  });
}
